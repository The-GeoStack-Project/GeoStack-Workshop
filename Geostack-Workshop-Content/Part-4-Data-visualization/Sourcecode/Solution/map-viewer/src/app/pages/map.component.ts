	...
	createMap(): void {
		...
		let baseLayer = new ol.layer.Tile({
			source: new ol.source.XYZ({
				...
				url: 'http://localhost/tiles/openstreetmap/{z}/{x}/{y}.png'
			})
		});
	...
	createPointLayer(transmissions): void {
        ...
        */
		transmissions.forEach(row => {
			...
			let pointGeometry = new ol.geom.Point(
				...
				ol.proj.fromLonLat(row.coord.coordinates)
			);
			...
			let pointFeature = new ol.Feature({
				type: "Point",
				geometry: pointGeometry, //TODO: Add the converted coordinates, from the previous TODO, as geometry of the feature
			});
		...
		*/
		let pointVectorSource = new ol.source.Vector({
			features: pointFeatureList //TODO: Add the list of PointFeatures as value of the VectorSource Features.
		});
	...
	createLineLayer(transmissions): void {
      ...
      */
		...
		/**
		 ...
		 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
		 */
		this.map.addLayer(lineVectorLayer) //TODO:
		/**
		 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
		 #                              END ASSIGNMENT 4                                 #
		 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
