...
def import_data():
    ...
    load_data(pd.read_csv('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/CSV/20181003_Dataset_SV_GPS_Crane_9407_Crane_RRW-BuGBk_Agnetha.csv'),"Agnetha")
    load_data(pd.read_csv('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/CSV/20181003_Dataset_SV_GPS_Crane_9381_Crane_RRW-BuGBk_Frida.csv'),"Frida")
    load_data(pd.read_csv('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/CSV/20181003_Dataset_SV_GPS_Crane_9472_Crane_RRW-BuGR_Cajsa.csv'),"Cajsa")
