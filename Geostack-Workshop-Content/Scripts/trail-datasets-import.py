...
def import_data():
    ...
    load_data(pd.read_json('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/JSON/Route-Biesbosch.json'),"Biesbosch")
    load_data(pd.read_json('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/JSON/Route-Zeeland_Car_1.json'),"Zeeland-Car-1")
    load_data(pd.read_json('~/GeoStack-Workshop/Geostack-Workshop-Content/Workshop-Datasets/JSON/Route-Zeeland_Car_2.json'),"Zeeland-Car-2")
